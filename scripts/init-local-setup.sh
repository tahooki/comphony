...
echo "  3. Ask Codex to set up the current Comphony runtime foundation end-to-end"
echo "  4. Run ./tests/validate-setup.sh"
echo "  5. Optional: run ./scripts/install-global-ui-ux-pro-max.sh to register the UI skill in global Codex"
