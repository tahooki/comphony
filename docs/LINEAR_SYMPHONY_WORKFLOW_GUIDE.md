...
- Comphony 루트: `/Users/you/Documents/comphony`
- 원본 레포 루트: `/Users/you/Documents/comphony/repos`
- Workflow 파일 루트: `/Users/you/Documents/comphony/workflows`
- Workspace 루트: `/Users/you/Documents/comphony/workspaces`
- 이슈 `FOO-12`의 실제 작업 폴더 예시: `/Users/you/Documents/comphony/workspaces/product-foo/FOO-12`
...
예시 workflow의 핵심 부분은 이런 의미다.

```yaml
tracker:
  kind: linear
  project_slug: "product-foo-project-slug"
...
- `/Users/you/Documents/comphony/repos/repo_a`
...
workspace:
  root: /Users/you/Documents/comphony/workspaces/repo_b
...
5. 원본 저장소는 `comphony/repos` 아래에 모은다.
...
- 로컬 파일 시스템에서는 `repos/workspaces/workflows` 구조가 가장 덜 헷갈린다.
