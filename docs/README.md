...
20. [SCENARIO_MATRIX.md](SCENARIO_MATRIX.md)
21. [ISSUE_LIFECYCLE.md](ISSUE_LIFECYCLE.md)
22. [WORKFLOW_PARTS.md](WORKFLOW_PARTS.md)

## Transitional Setup And Legacy References

아래 문서들은 여전히 유용하지만, 현재 canonical 제품 모델보다 `Symphony + Linear` 기반 실행 자산 쪽에 더 가깝다.

23. [START_WITH_CODEX.md](START_WITH_CODEX.md)
24. [LOCAL_LAYOUT.md](LOCAL_LAYOUT.md)
25. [SYMPHONY_BASICS.md](SYMPHONY_BASICS.md)
26. [LINEAR_SYMPHONY_WORKFLOW_GUIDE.md](LINEAR_SYMPHONY_WORKFLOW_GUIDE.md)
