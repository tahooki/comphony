...
workspace:
  root: /Users/tahooki/Documents/symphony-workspaces/product-foo

hooks:
  after_create: |
    git clone --depth 1 file:///Users/tahooki/Documents/git/product-foo .
...
```bash
./bin/symphony ./WORKFLOW.product-foo.md
```
...
- 원본 repo: `/Users/tahooki/Documents/git/product-foo`
- workspace root: `/Users/tahooki/Documents/symphony-workspaces/product-foo`
- 특정 이슈 workspace: `/Users/tahooki/Documents/symphony-workspaces/product-foo/FOO-12`
